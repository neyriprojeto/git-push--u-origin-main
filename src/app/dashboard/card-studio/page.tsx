...
const defaultElements: CardElements = {
    ...
    'Label CPF': { position: { top: 68, left: 70 }, size: { fontSize: 10 }, text: 'CPF:', textAlign: 'left' },
    'Label Data de Batismo': { position: { top: 74, left: 40 }, size: { fontSize: 10 }, text: 'Batismo:', textAlign: 'left' },
    ...
    'Valor CPF': { position: { top: 68, left: 78 }, size: { fontSize: 10 }, text: memberSample.cpf, textAlign: 'left' },
    'Valor Data de Batismo': { position: { top: 74, left: 54 }, size: { fontSize: 10 }, text: '01/01/2024', textAlign: 'left' },
