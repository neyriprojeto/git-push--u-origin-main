...
const defaultElements: CardElements = {
    ...
    'Nome': { position: { top: 58, left: 40 }, size: { fontSize: 11 }, text: `Nome: NOME DO MEMBRO`, fontWeight: 'normal', textAlign: 'left' },
    'Registro': { position: { top: 66, left: 40 }, size: { fontSize: 10 }, text: `Nº Reg.: 0000`, textAlign: 'left' },
    'Nascimento': { position: { top: 72, left: 40 }, size: { fontSize: 10 }, text: `Nasc: 00/00/0000`, textAlign: 'left' },
    'RG': { position: { top: 78, left: 40 }, size: { fontSize: 10 }, text: `RG: 00.000.000-0`, textAlign: 'left' },
    'CPF': { position: { top: 84, left: 40 }, size: { fontSize: 10 }, text: `CPF: 000.000.000-00`, textAlign: 'left' },
    'Cargo': { position: { top: 90, left: 40 }, size: { fontSize: 10 }, text: `Cargo: Membro`, textAlign: 'left' },
