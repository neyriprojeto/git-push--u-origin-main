...
export default function MemberFilePage() {
    ...
    return (
        <div className="w-full min-h-screen bg-secondary p-4 flex flex-col justify-center items-center font-serif print:bg-white print:p-0">
            ...
            <div className="w-full max-w-5xl print-container">
                {/* Página 1: Frente da Ficha */}
                <div className="print-page bg-white shadow-lg p-[2vw] md:p-8 flex flex-col aspect-[1.414/1]">
                    {/* Header */}
                ...
                {/* Página 2: Verso da Ficha (escondida na tela, visível na impressão) */}
                <div className="print-page bg-white shadow-lg p-[2vw] md:p-8 flex flex-col aspect-[1.414/1] print:shadow-none print:border-none">
